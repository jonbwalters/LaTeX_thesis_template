...
\begin{figure}[hbt] %% figure
	...
	Image credit: \url{mime.oregonstate.edu/news/story/2103}, (Right)
	Morphing gull wings.
	}
	\label{batgull2}
\end{figure}
...
comment out the \verb+\include{tables}+ command in
\verb+thesis.tex+.
...
Matrices are built quite similarly to tables, however they don't
take alignment options using the built in environments. The
\verb+amsmath+ package include several convenient matrix environments
depending on what kind of brace of bracket you want.
\begin{equation*}
	\begin{vmatrix}
		a & b\\
		c & d
